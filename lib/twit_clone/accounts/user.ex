defmodule TwitClone.Accounts.User do
  ...
  defp maybe_set_default_avatar(changeset) do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, TwitClone.Repo)
  ...
  """
  def valid_password?(%TwitClone.Accounts.User{hashed_password: hashed_password}, password)
